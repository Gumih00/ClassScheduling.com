    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse move-me">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="generatetimetable.php">GENERATE SCHEDULE</a></li>
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        echo "College of Computing, Multimedia Arts and Digital Innovation " . $_POST['select_semester'] . " ";
            ...
            <tr>
                ...
                <td style="text-align:center">2:00-3:30</td>
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA CLASS SCHEDULING SYSTEM, COLLEGE OF COMPUTING, MULTIMEDIA AND DIGITAL INNOVATION.";
